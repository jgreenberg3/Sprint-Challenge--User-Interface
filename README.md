...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    A: Semantic HTML is the process of organizing your code into easily discernible sections. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.

    A: Display: block will do a line break after every block. Display: inline can have multiple blocks on the same line. 
...
5. Explain why git is valuable to a team of developers.
    ...
    A: Because they can all work together on a project and track their changes. 
